// lib/features/vehicle_management/presentation/pages/carrier/profile/profile_screen2.dart
import 'dart:convert';
import 'dart:io';
...
class _ProfileScreen2State extends State<ProfileScreen2> {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        if (p != null) {
          ...
          _show('No se encontró un perfil que coincida.', isError: true);
        }
      } else {
        _show('Error al cargar los perfiles.', isError: true);
      }
    } catch (e) {
      _show('Error al obtener el perfil: $e', isError: true);
    } finally {
          ...
          children: [
            ...
            if (_companyName.isNotEmpty)
              Padding(
                ...
                child: Chip(
                  avatar: const Icon(Icons.business_outlined, color: _kAction, size: 18),
                  label: Text(_companyName, style: const TextStyle(color: _kTextMain)),
                  backgroundColor: _kCard,
                ),
              ),
  ...
  Widget _buildProfileAvatar() {
    final imageProvider = _pickedImgFile != null
        ...
        : const AssetImage('assets/images/transportista.png')) as ImageProvider;
